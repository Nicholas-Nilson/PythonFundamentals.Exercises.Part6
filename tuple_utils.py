...
def tic_tac_toe_finish(board: TicTacToeBoard, pos_x: int, pos_y: int, symbol: str) -> None:
    """
    ...
    :param pos_x: The position of the TicTacToeRow that needs to be modified
    :param pos_y: The position of the column within a TicTacToeRow that needs to be modified
